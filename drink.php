...
<?php
	...
	$sql = "SELECT food_name,food_image,address,storehour FROM food where (food_kind='$drink')";
		...
		while($meta=mysqli_fetch_object($result))
	{
			...
			echo "<tr><td><strong> 地址: $meta->address</td></strong></tr>";
